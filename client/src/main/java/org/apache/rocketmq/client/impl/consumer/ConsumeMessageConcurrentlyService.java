...
//        System.out.println(String.format("%s > 本次将提交 [%d] 条消费请求", Thread.currentThread().getName(), msgs.size()));
        ...
        if (msgs.size() <= consumeBatchSize) {
            // ConsumeRequest 是个线程, 消费会在该线程的 run 方法中执行
